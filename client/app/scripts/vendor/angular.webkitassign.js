...
var $AnimateProvider = ['$provide', function($provide) {
  ...
  this[__webkitAssign__$$selectors] = {};
  ...
  this[__webkitAssign__$get] = ['$$q', '$$asyncCallback', '$rootScope', function($$q, $$asyncCallback, $rootScope) {

    var currentDefer;

    function runAnimationPostDigest(fn) {
      var cancelFn, defer = $$q.defer();
      defer.promise[__webkitAssign__$$cancelFn] = function ngAnimateMaybeCancel() {
        cancelFn && cancelFn();
      };
    ...
    return {
      ...
      setClass: function(element, add, remove, options) {
        ...
        if (!cache) {
          ...
          cache[__webkitAssign__options] = angular.extend(cache.options || {}, options);
        }
        ...
        if (createdCache) {
          cache[__webkitAssign__promise] = runAnimationPostDigest(function(done) {
            var cache = element.data(STORAGE_KEY);
...
function Browser(window, document, $log, $sniffer) {
   ...
   */
  self[__webkitAssign__addPollFn] = function(fn) {
   ...
   */
  self[__webkitAssign__cookies] = function(name, value) {
    var cookieLength, cookieArray, cookie, i, index;

    if (name) {
      if (value === undefined) {
        rawDocument[__webkitAssign__cookie] = encodeURIComponent(name) + "=;path=" + cookiePath +
                                ";expires=Thu, 01 Jan 1970 00:00:00 GMT";
      } else {
        if (isString(value)) {
          cookieLength = (rawDocument[__webkitAssign__cookie] = encodeURIComponent(name) + '=' + encodeURIComponent(value) +
...
function $CompileProvider($provide, $$sanitizeUriProvider) {
            ...
            forEach(hasDirectives[name], function(directiveFactory, index) {
              try {
                ...
                if (isObject(directive.scope)) {
                  directive[__webkitAssign__$$isolateBindings] = parseIsolateBindings(directive.scope, directive.name);
                }
  ...
  this[__webkitAssign__$get] = [
    ...
    function applyDirectivesToNode(directives, compileNode, templateAttrs, transcludeFn,
      ...
      nodeLinkFn[__webkitAssign__elementTranscludeOnThisElement] = hasElementTranscludeDirective;
      ...
      function nodeLinkFn(childLinkFn, scope, linkNode, $rootElement, boundTranscludeFn) {
        ...
        if (newIsolateScopeDirective) {
          ...
          forEach(isolateScope[__webkitAssign__$$isolateBindings] = newIsolateScopeDirective.$$isolateBindings, function(definition, scopeName) {
...
function $HttpProvider() {
  ...
  this[__webkitAssign__$get] = ['$httpBackend', '$browser', '$cacheFactory', '$rootScope', '$q', '$injector',
...
function parseAbsoluteUrl(absoluteUrl, locationObj) {
  ...
  locationObj[__webkitAssign__$$port] = int(parsedUrl.port) || DEFAULT_PORTS[parsedUrl.protocol] || null;
}
...
forEach({
  ...
  constantGetter[__webkitAssign__constant] = constantGetter[__webkitAssign__literal] = constantGetter[__webkitAssign__sharedGetter] = true;
  CONSTANTS[name] = constantGetter;
});

//Not quite a constant, but can be lex/parsed the same
CONSTANTS['this'] = function(self) { return self; };
CONSTANTS['this'][__webkitAssign__sharedGetter] = true;
...
Parser[__webkitAssign__ZERO] = extend(function() {
  return 0;
}, {
  sharedGetter: true,
  constant: true
...
Parser[__webkitAssign__prototype] = {
  ...
  parse: function(text) {
    ...
    value[__webkitAssign__literal] = !!value.literal;
    value[__webkitAssign__constant] = !!value.constant;
...
function getterFn(path, options, fullExp) {
  ...
  if (options.csp) {
    ...
    /* jshint +W054 */
    evaledFnGetter[__webkitAssign__toString] = valueFn(code);
  ...
  fn[__webkitAssign__sharedGetter] = true;
  fn[__webkitAssign__assign] = function(self, value, locals) {
  ...
  this[__webkitAssign__$get] = ['$filter', '$sniffer', function($filter, $sniffer) {
    ...
    function wrapSharedExpression(exp) {
      ...
      if (exp.sharedGetter) {
        ...
        wrapped[__webkitAssign__literal] = exp.literal;
        wrapped[__webkitAssign__constant] = exp.constant;
        wrapped[__webkitAssign__assign] = exp.assign;
      }
    ...
    function inputsWatchDelegate(scope, listener, objectEquality, parsedExpression) {
      var inputExpressions = parsedExpression.$$inputs ||
                    (parsedExpression[__webkitAssign__$$inputs] = collectExpressionInputs(parsedExpression.inputs, []));
    ...
    function addInterceptor(parsedExpression, interceptorFn) {
      ...
      if (parsedExpression.$$watchDelegate &&
        ...
        fn[__webkitAssign__inputs] = [parsedExpression];
      }
  ...
  this[__webkitAssign__$get] = ['$injector', '$exceptionHandler', '$parse', '$browser',
    ...
    Scope[__webkitAssign__prototype] = {
      ...
      $destroy: function() {
        ...
        if (parent.$$childHead == this) parent[__webkitAssign__$$childHead] = this.$$nextSibling;
        if (parent.$$childTail == this) parent[__webkitAssign__$$childTail] = this.$$prevSibling;
...
var ngModelOptionsDirective = function() {
  return {
    ...
    controller: ['$scope', '$attrs', function($scope, $attrs) {
      var that = this;
      this[__webkitAssign__$options] = $scope.$eval($attrs.ngModelOptions);
...
// jshint maxlen: 100
  ...
  return {
    ...
    controller: ['$element', '$scope', '$attrs', function($element, $scope, $attrs) {
      ...
      self[__webkitAssign__databound] = $attrs.ngModel;


      self[__webkitAssign__init] = function(ngModelCtrl_, nullOption_, unknownOption_) {
      ...
      self[__webkitAssign__addOption] = function(value, element) {
        ...
        if (element && element[0].hasAttribute('selected')) {
          element[0][__webkitAssign__selected] = true;
        }
      };
    ...
    link: function(scope, element, attr, ctrls) {
      ...
      function setupAsOptions(scope, selectElement, ctrl) {
        ...
        ctrl[__webkitAssign__$render] = render;
          ...
          for (groupIndex = 0, groupLength = optionGroupNames.length;
            ...
            if (optionGroupsCache.length <= groupIndex) {
              ...
              if (existingParent.label != optionGroupName) {
                existingParent.element.attr('label', existingParent[__webkitAssign__label] = optionGroupName);
              }
            }
            ...
            for (index = 0, length = optionGroup.length; index < length; index++) {
              ...
              if ((existingOption = existingOptions[index + 1])) {
                ...
                if (existingOption.label !== option.label) {
                  ...
                  lastElement.text(existingOption[__webkitAssign__label] = option.label);
                  lastElement.prop('label', existingOption.label);
                }
                if (existingOption.id !== option.id) {
                  lastElement.val(existingOption[__webkitAssign__id] = option.id);
                }
                // lastElement.prop('selected') provided by jQuery has side-effects
                if (lastElement[0].selected !== option.selected) {
                  lastElement.prop('selected', (existingOption[__webkitAssign__selected] = option.selected));
                  if (msie) {
                    // See #7692
